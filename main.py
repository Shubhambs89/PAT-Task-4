...
print("1. Finding Even and Odd numbers from my_list")
print('Even Numebrs: ')
for num in my_list:
    if num % 2 == 0:
        print(num)
...
print('2. Finding the prime numbers and count of prime numbers from my_list')
prime_numbers = []
for numb in my_list:
    if numb > 1:
        is_prime = True
...
print('4. Finding the sum of first and last digit of the interger')
a=my_list[0]
b=my_list[7]
print('The sum of first and last digit ',a+b)
print()

print('5. ways to make 10 rs using coins of 1 rs, 2 rs, 5 rs and 10 rs')
Total = 10
ways = 0
...
print('6. Find the dulicates in three lists')
...
print(intersection_set[0])
print()

print('7. finding the first duplicate number')

for num in Set1:
    if num in Set2 and num in Set3:
        print("First Duplicate number is :", num)
        print()
        break
print()

print('8. minimum element in rated and sorted list')
...
print('10. Sub list with sum equal to zero')
